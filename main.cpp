...
int main() {
    ...
    world.camera.configure(3, 60, 800, 600, vec3(0, 0, 100), vec3(0, 0, 0),
                           vec3(0, 1, 0));
    Plane *plane = new Plane(vec3(0, -10, -60), vec3(0, 1, 0), vec3(1, 1, 0));
    world.addObject(plane);
    for (int i = 0; i < 50; i++) {
        Sphere *sphere = new Sphere(vec3(randomFloat(-60, 60), randomFloat(10, 40), randomFloat(1, 10)), randomFloat(1, 10), vec3(randomFloat(0, 1), randomFloat(0, 1), randomFloat(0, 1)));
